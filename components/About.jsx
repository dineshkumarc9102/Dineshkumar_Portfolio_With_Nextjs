...
const About = ({ isDarkMode }) => {
    return (
        ...
        >
            ...
            <motion.div className='flex flex-col lg:flex-row gap-10 sm:gap-20 items-start my-20 w-full'
                initial={{ opacity: 0 }}
                whileInView={{ opacity: 1 }}
                transition={{ duration: 0.8 }}
            >
                {/* === Image Section === */}
                <motion.div className='w-full lg:w-[40%] max-w-xs sm:max-w-sm mx-auto lg:mx-0 rounded-3xl'
                    initial={{ scale: 0.9, opacity: 0 }}
                    whileInView={{ scale: 1, opacity: 1 }}
                    transition={{ duration: 0.6 }}
                >
                    <Image
                        ...
                        alt='Profile'
                        className='w-full rounded-3xl transition-all duration-300 hover:scale-105'
                    />
                </motion.div>

                {/* === Text Section === */}
                <motion.div className='flex-1 text-justify'
                    initial={{ opacity: 0 }}
                    whileInView={{ opacity: 1 }}
                    transition={{ duration: 0.8, delay: 0.6 }}
                >
                    {/* Paragraph */}
                    <p className='mb-6 sm:mb-10 text-sm sm:text-base font-Ovo'>
                    ...
                    {/* Info Cards */}
                    {/* <motion.ul className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6'
                        initial={{ opacity: 0 }}
                        whileInView={{ opacity: 1 }}
                        transition={{ duration: 0.8, delay: 1 }}
                    >
                        {infoList.map(({ icon, iconDark, title, description }, index) => (
                            <motion.li
                                key={index}
                                whileHover={{ scale: 1.05 }}
                                className='border-[0.5px] border-gray-400 dark:border-white rounded-xl p-6 cursor-pointer hover:bg-lightHover dark:hover:bg-darkHover/50 hover:-translate-y-1 duration-500 hover:shadow-black dark:hover:shadow-white'
                            >
                                <a href={title === 'Education' ? "#education" : "#project"}>
                                    <Image src={isDarkMode ? iconDark : icon} alt={title} className='w-7 mt-3' />
                                    <h3 className='my-4 font-semibold text-gray-700 dark:text-white'>{title}</h3>
